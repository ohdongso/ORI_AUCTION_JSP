...
public interface SuccedBidDAO {
	 ...
	 * */
	int insert(SuccedBidDTO succedBidDTO) throws SQLException;
	 ...
	 * 결제 완료된 경매 상태 변경
	 * */
	int changeState(int sucBidCode) throws SQLException;
	 ...
	 * 낙찰 정보 수정
	 * */
	int updateSucBid(SuccedBidDTO succedBidDTO) throws SQLException;
	
	/**
	 * 낙찰 정보 삭제 -- by관리자
	 *  ex) 낙찰 받은 회원의 낙찰 취소시
	 * */
	int deleteSucBid(int sucBidCode, String id) throws SQLException;
