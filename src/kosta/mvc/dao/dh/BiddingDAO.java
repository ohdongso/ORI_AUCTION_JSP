...
public interface BiddingDAO {
	 ...
	 * */
	int insertBid(BiddingDTO biddingDTO) throws SQLException;
	 ...
	 * 경매코드와 ID로 중복 응찰 확인
	 * */
	BiddingDTO checkByAucCodeId(int aucCode, String loginUser) throws SQLException;
	...
	/**
	 * 회원 아이디로 응찰 내역과 함께 작품 상태도 불러올 때
	 * */
	 ...
	 *    ex) 금액을 잘못 입력했을 때
	 * */
	int updateBid(BiddingDTO biddingDTO) throws SQLException;
	 ...
	 * */
	int deleteBid(int bidCode, String id) throws SQLException;

	/**
	 * 경매코드로 해당 경매에 가장 많은 금액을 먼저 응찰한 사용자를 찾기
	 * */
	BiddingDTO selectTopBid(int aucCode) throws SQLException;
