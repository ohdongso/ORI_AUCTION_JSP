...
<body>
   ...
   <header class="main_menu home_menu">
	...
	<section>
			...
			<div style="position:absolute; left: 320px; top: 300px;z-index: 2;">
				<p id="oti">General Auctions
				<p>
	...
	<!-- breadcrumb start-->
		...
		<form id="form" action="${path}/front?key=auction&methodName=searchMinMax" method="post" style="width:-10px;float:left;">
			...
			<input type="submit"  value="검색" id="modify" />
			<input type="hidden" name="aucCategory" value="1">
		</form>
		</div>
		...
		<div id="c">
		<form action="${path}/front?key=auction&methodName=selectAuction&aucCategory=1" name="search" id="search" method="post" style="width:-10px;float:left;">
			<input type="submit"  value="전체검색" id="delete">
		</form>		
		</div>
