...
<body>
   ...
   <header class="main_menu home_menu">
	...
	<section>
			...
			<div style="position:absolute; left: 260px; top: 300px;z-index: 2;">
				<p id="oti">Zero-Base Auctions
				<p>
				
			</div>
			<h1 style="font-family: ITC Grouch; text-align: center">Through Ori Auction, meet new Artist!</h1><br><br>
	...
	<!-- breadcrumb start-->
		...
		<form id="form" action="${path}/front?key=auction&methodName=searchMinMax" method="post" style="width:-10px;float:left;">
			...
			<input type="hidden" name="aucCategory" value="3">
		</form>
		</div>
		...
		<div id="c">											
		<form action="${path}/front?key=auction&methodName=selectAuction&aucCategory=3" name="search" id="search" method="post" style="width:-10px;float:left;">
