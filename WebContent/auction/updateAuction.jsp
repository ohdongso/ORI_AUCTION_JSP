...
<body>
   ...
   <header class="main_menu home_menu">
    ...
    <div class="container">
        <h1 id="banana">Modify Your Auction Details</h1>
		<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>
		<form action="${path}/front?key=auction&methodName=updateAuction" method="post">
	    ...
	    <tr>
	    	...
	    	<td>
	    		<input type="text" value="${requestScope.auctionDto.artCode}" disabled="disabled">
	    	</td>
	    </tr>
	    ...
	    <tr>
	    	...
	    	<td>
	    	<c:choose>
				<c:when test="${requestScope.auctionDto.art.artCategory == 1}"> <input type="text" value="사진" disabled="disabled"> </c:when>
				<c:when test="${requestScope.auctionDto.art.artCategory == 2}"> <input type="text" value="회화" disabled="disabled"> </c:when>
				<c:when test="${requestScope.auctionDto.art.artCategory == 3}"> <input type="text" value="공예" disabled="disabled"> </c:when>
			</c:choose>
	    	</td>
	    </tr>
	   	...
	   	<tr>
	    	...
	    	<td>
	    		<input type="text" value="${requestScope.auctionDto.art.artName}" disabled="disabled">
	    	</td>
	    </tr>
	   	...
	   	<tr>
	    	...
	    	<td>
	    		<input type="text" value="${requestScope.auctionDto.art.estimateCost}" disabled="disabled">
	    	</td>
	    </tr>
	    ...
	    <tr>
	    	...
	    	<td>
	    		<input type="text" name="updateStartCost" value="${requestScope.auctionDto.firstCost}">
	    	</td>
	   		</tr>
	   	</table>
	   		
	   		<input type="submit" id="modify" value="등록">
			<input type="reset" id="delete" value="입력내용초기화">
		
			<input type="hidden" name="aucCode" value="${param.aucCode}"/>
			<input type="hidden" name="aucState" value="${param.aucState}"/>
			<input type="hidden" name="artCode" value="${param.artCode}"/>
	   ...
	   <!--                          
		작품코드 : <input type="text" value="${requestScope.auctionDto.artCode}" disabled="disabled"> <br>
		
		<c:choose>
			<c:when test="${requestScope.auctionDto.art.artCategory == 1}"> 카테고리 : <input type="text" value="사진" disabled="disabled"> </c:when>
			<c:when test="${requestScope.auctionDto.art.artCategory == 2}"> 카테고리 : <input type="text" value="회화" disabled="disabled"> </c:when>
			<c:when test="${requestScope.auctionDto.art.artCategory == 3}"> 카테고리 : <input type="text" value="공예" disabled="disabled"> </c:when>
		</c:choose> <br>
		
		작품명 : <input type="text" value="${requestScope.auctionDto.art.artName}" disabled="disabled"> <br>
		추정가 : <input type="text" value="${requestScope.auctionDto.art.estimateCost}" disabled="disabled"> <br>
		시작가 : <input type="text" name="updateStartCost" value="${requestScope.auctionDto.firstCost}"> <br>
		
		<input type="submit" value="등록">
		<input type="reset" value="입력내용초기화">
