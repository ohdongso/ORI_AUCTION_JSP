	...
	<section class="cat_product_area section_padding">
		<div class="section-top-border" align="center">
			<div class="col-lg-8 col-md-8">
				<h3 style="font-family: ITC Grouch;">Write Board</h3>
				<form name="writeForm" method="post"
					...
					<div class="mt-10">
						<select  name="boardCategory"
							...
							<option value="1">질문(ask)</option>
							<option value="2">일반(free)</option>
							<option value="3">정보(info)</option>
					...
					<div class="mt-10">
						...
						<input type="file" name="file"  class="single-input" >
					</div>
					<div>
						<hr>
					</div>
