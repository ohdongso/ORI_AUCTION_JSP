...
<style>
   ...
   border:0; outline:0; padding:10px 30px; font-size: 12px; }
...
<body>
	...
	<section>
			...
			<div style="position: relative; z-index: 1; margin-bottom: 80px;">
				<img src="${path}/img/serb.png" width="100%" alt=""
					class="img-fluid" style="margin-top: 80px" id="mainI">
			</div>
			<div style="position:absolute; left: 420px; top: 280px; z-index: 2;">
				<p id="oti">Free Board
				<p>
			</div>
				...
				<div class="col-lg-12">
					<div
						...
						<div class="single_product_menu d-flex">
							<p style="font-family: adobe-caslon-pro, serif; font-weight: bold;">
			...
			<div class="col-lg-12">
				<div class="progress-table-wrap" style="overflow: hidden">
							...
							<c:choose>
								...
								<c:when test="${empty requestScope.boardList}">
									<tr>
										<td colspan="7">
											<p align="center">
												<b><span style="font-family: adobe-caslon-pro, serif; font-weight: bold;">등록된 게시물이 없습니다.</span></b>
											</p>
										</td>
									</tr>
								</c:when>
					...
					<div class="col-lg-12" style="text-align: right">
						<a href="${path}/msBoard/write.jsp" id="modify">Write</a>
					</div>
