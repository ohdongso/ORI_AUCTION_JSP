	...
	<section class="cat_product_area section_padding">
		<div class="section-top-border" align="center">
			<div class="col-lg-8 col-md-8">
				<h1 id="oti">Update board</h1>
				<form name="writeForm" method="post" action="${path}/front?key=sb&methodName=update"
					onSubmit='return checkValid()'>
					
					<input type="hidden" name="serviceBoardCode" value="${param.serviceBoardCode}" />
					...
					<div class="mt-10">	
						<input type="text" name="serviceBoardTitle" placeholder="Title"
							...
							class="single-input" value="${param.serviceBoardTitle}">
					</div>
					
					<hr>
					<h6>Category</h6>
					<div class="mt-10">
						<select id="selectRate" name="serviceBoardCategory"
							style="width: 100%; font-size: 15px" class="single-input" >
							<option value="${param.serviceBoardCategory}">등록된 카테고리 : ${param.serviceBoardCategory}</option>
							<option value="1">1회원정보</option>
							<option value="2">2경매</option>
							<option value="3">3위탁</option>
							<option value="4">4배송</option>
							<option value="5">5기부</option>
							<option value="6">6기타</option>
					...
					<div class="mt-10">
						<textarea name="serviceBoardContent" class="single-textarea"
							...
							style="height: 300px">${param.serviceBoardContent} </textarea>
					</div>
					
					<div align="right">
					
						<button type="submit" id="modify">Complete</button>
					</div>
				</form>
			</div>
		</div>
