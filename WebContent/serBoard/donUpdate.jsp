			...
			<div class="section-top-border">
				<div align="center">
					<div class="col-lg-8 col-md-8" style="width: 900px">
						...
						<form name="writeForm" method="post" action="${path}/front?key=donation&methodName=update">
							
							<div class="mt-10">
								<input type="text" name="donCode" 
									class="single-input" value="${donDTO.donCode}" readonly="readonly">
							</div>
							<div class="mt-10">
								<input type="text" name="donTitle" placeholder="Title"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Title'" required
									class="single-input" value="${donDTO.donTitle}">
							</div>
							<div class="mt-10">
								<textarea class="single-textarea" name="donContent" placeholder="Content"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Detail'" required style="height:400px" >${donDTO.donContent}</textarea>
							</div>
							<div class="mt-10">
								<input type="text" name="donDate" placeholder="Donation Date (YYYY/MM/DD)"
									...
									class="single-input" value="${donDTO.donDate}">
							</div>
							<!-- <div class="mt-10">
