...
<body>
  ...
  <section>
			...
			<div style="position: relative; z-index: 1; margin-bottom: 80px;">
				<img src="${path}/img/in.png" width="110%" alt=""
					class="img-fluid" style="margin-top: 80px" id="mainI">
			</div>
			<div style="position:absolute; left: 270px; top: 300px; z-index: 2;">
				<p id="oti">Your Information
				<p>
			</div>
			<h1 id="forma" style="font-family:ITC Grouch; text-align:center;"> ${memberDTO.id}'s Information </h1>
  ...
  <!--================Cart Area =================-->
        ...
        <tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>
          ...
          <form action="${path}/member/modifyInform.jsp" method="post">
            <input type="hidden" name="id" value="${memberDTO.id}">
         	 <input type="hidden" name="pw" value="${memberDTO.pw}">
         	   <input type="hidden" name="name" value="${memberDTO.name}">
         	     <input type="hidden" name="account" value="${memberDTO.account}">
         	       <input type="hidden" name="addr" value="${memberDTO.addr}">
         	         <input type="hidden" name="contact" value="${memberDTO.contact}">
         	           <input type="hidden" name="email" value="${memberDTO.email}">
          <button type="submit" id="modify" >Modify Information</button><p><br><hr>
          <a href="${path}/member/delete.jsp" class="delete">Delete Account</a>
  		  </form> 
  	</div>  
  </section>
  <!--================End Cart Area =================-->
