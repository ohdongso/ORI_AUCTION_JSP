...
<script type="text/javascript" src="../js/jquery-3.6.0.min.js"></script>
   ...
   #goBack{font-family: ITC Grouch; background-color: black; color:yellow;
   border:0; outline:0; padding:10px 30px; font-size: 15px; }
...
<body>
  ...
  <section class="cart_area padding_top">
    <div class="container">
        <h2 id="banana">Are you sure to delete your account?</h2><p><br><p><br><p><br>
        <h6 id="check"> Please enter the information again to confirm the correct information.</h6><p><br>
        <tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>
          <form name="updateMemberInfo" method="post" action="${path}/front?key=member&methodName=deleteMember" >
          ...
          <button type="submit" id="modify" >Delete Account</button>
          <button type="button" id="goBack" onClick="history.back(-1);" >Cancle</button>
      </form>
     </div>
  </section>
  <!--================End Cart Area =================-->
