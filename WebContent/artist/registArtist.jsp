...
<head>
    ...
    <link rel="stylesheet" href="${path}/css/style.css">
	    ...
	    <style>
		    #mainLogo{width:200px; height:40px}
			...
			#mainSample1{width:600px; height:400px}
			...
			#oti{font-family:ITC Grouch; font-size: 100px; text-align: center; color:white;}
			 #modify{font-family: ITC Grouch; background-color: yellow; color:black;
   align:right; border:0; outline:0; padding:10px 30px; font-size: 15px; }
    	 ...
    	 $(function () {
 			$("form[name=joinForm]").submit(function(){
 				alert("작가등록 완료. 정보 업데이트를 위해 다시 한번 로그인해주세요")
...
<body>
    ...
    <section>
			...
			<div style="position: relative; z-index: 1; margin-bottom: 80px;">
				<img src="${path}/img/231.jpg" width="110%" alt=""
					class="img-fluid" style="margin-top: 80px" id="mainI">
			</div>
			<div style="position:absolute; left: 250px; top: 300px; z-index: 2;">
				<p id="oti">Regist as an Artist <br> 
				<p>
			</div>
			<h1 id="forma" style="font-family:ITC Grouch; text-align:center;"> Artist Application Form </h1>
    ...
    <section class="artist form">
        <div style="margin:auto;text-align:center;">
        	<form name="joinForm" style="display:inline-block;" action="${path}/front?key=artist&methodName=registArtist" method=post onsubmit="artistFormCheck()" enctype="multipart/form-data" >
				<input type="text" class="underline" type="text" > <br><br>
				<h5 id="detail">Profile Photo</h5>
					<div class="mt-10">
					<input type="file" name="artistImg" maxlength="60" size="40" required class="single-input" >
					</div>
				<h5 id="detail">Your Career</h5>
					<div class="md-form amber-textarea active-amber-textarea">
	  				<textarea id="form19" class="md-textarea form-control" rows="10" name="career" placeholder="Career"></textarea>
	 				 <label for="form19">.</label>
					</div>
				<h5 id="detail">Details</h5>
					<div class="md-form amber-textarea active-amber-textarea">
	  				<textarea id="form19" class="md-textarea form-control" rows="10" name="artistDetail" placeholder="0/1000"></textarea>
	 				 <label for="form19">.</label>
					</div>
				<h5 id="detail">Profile Link</h5>
					<div class="md-form amber-textarea active-amber-textarea">
	  				<textarea id="form19" class="md-textarea form-control" rows="2" name="profileLink" placeholder="(optional)"></textarea>
	 				 <label for="form19">.</label>
					</div>		
					 <br><br>
				
				<input type="submit" title="Regist as an Artist" id="joinbutton" value="Regist as an Artist">
    		</form>	
