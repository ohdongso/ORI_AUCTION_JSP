...
<body>
	...
	<section>
			...
			<div style="position: relative; left: 10px; top: -400px; z-index: 2;">
				<p id="oti">Update your Artist Profile! <br> 
				<p>
			</div>
			<h1 id="forma" style="font-family:ITC Grouch; text-align:center;"> Your Profile</h1>
	...
	<section class="artist form">
		<div style="margin: auto; text-align: center;">
			<form name=joinForm style="display: inline-block;"
				action="${path}/front?key=artist&methodName=updateArtist"
				method=post onsubmit="artistFormCheck()"
				enctype="multipart/form-data">
				<input type="text" class="underline" type="text"> <br>
				<br>
				<h5 id="detail">Profile Photo</h5>
				<div class="mt-10">
					${param.artistImg}<br>
					<br>
					<h6 id="detail">If you want to change your profile Photo,
						select your new file!</h6>
					<input type="hidden" name="beforFileName"
						value="${param.artistImg}"> 
					<input type="file" name="file"
						maxlength="60" size="40" class="single-input">
					<br>
					<br>
				</div>
				<h4 id="detail">Your Career</h4>
				<div class="md-form amber-textarea active-amber-textarea">
					<textarea rows="" name="career" id="form19" rows="10">${param.career}</textarea>
					<p>
						<label for="form19"></label>
					<p>
				</div>
				<h4 id="detail">Details</h4>
				<div class="md-form amber-textarea active-amber-textarea">
					<textarea rows="" name="artistDetail" id="form19" rows="10">${param.artistDetail}</textarea>
					<p>
						<label for="form19"></label>
					<p>
				</div>
				<h4 id="detail">Profile Link</h4>
				<div class="md-form amber-textarea active-amber-textarea">
					<textarea name="profileLink" id="shot" rows="10">${param.profileLink}</textarea>
					<label for="form19"></label>
				</div>
				<br>
				<br> <input type="submit" title="Regist as an Artist"
					id="joinbutton" value="Confirm">
			</form>
