	...
	<section class="cat_product_area section_padding">
		<div class="section-top-border" align="center">
			<div class="col-lg-8 col-md-8">
				<h1 style="font-family: ITC Grouch;">Update Article</h1>
				<form name="writeForm" method="post"
					action="${path}/front?key=article&methodName=update"
					onSubmit='return checkValid()'
					
					>
					<input type="hidden" name="atcCode" value="${article.atcCode}">
					<input type="hidden" name="id" value="${sessionScope.loginUser}">
					<div class="mt-10">
						<input type="text" name="atcTitle"  required=""
							class="single-input" value="${article.atcTitle}">
					</div>
					...
					<div class="mt-10">
						<textarea name="atcContents" class="single-textarea"
							required=""
							style="height: 300px">${article.atcContents} </textarea>
					</div>
					<div class="mt-10">
						<input type="text" name="atcUrl" placeholder="atcUrl"
							required=""
							class="single-input" value="${article.atcUrl}">
					</div>
					<div>
						<hr>
					</div>
