	...
	<section class="cat_product_area section_padding">
		<div class="section-top-border" align="center">
			<div class="col-lg-8 col-md-8">
				<h1 style="font-family:ITC Grouch">Add Our New Article</h1>
				<form name="writeForm" method="post"
					action="${path}/front?key=article&methodName=insert"
					...
					<h6>Title</h6>
					<div class="mt-10">
						<input type="text" name="atcTitle" placeholder="Title"
							id ="atcTitle"
					...
					<h6>Content</h6>
					<div class="mt-10">
						<textarea name="atcContents" class="single-textarea"
					...
					<h6>URL</h6>
					<div class="mt-10">
						<textarea name="atcUrl" class="single-textarea"
							placeholder="URL" onfocus="this.placeholder = ''"
							onblur="this.placeholder = 'URL'" required=""
