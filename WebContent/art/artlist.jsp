				...
				<div class="col-lg-12">
					<div class="product_top_bar d-flex justify-content-between align-items-center">
						<div class="single_product_menu d-flex">
							<p>
								총 <span>${fn:length(artList)} </span> 개의 작품
							</p>
						</div>
						<div>
						<c:if test="${sessionScope.loginState==0}">
							...
							<span>Art State : 
								...
								class="genric-btn primary small" style="padding:0px 5px" title="보관중인 작품">보관중</a>
								<a href="${path}/front?key=art&methodName=searchByKeyWord&keyField=artState&keyWord=2" 
								class="genric-btn primary small" style="padding:0px 5px" title="경매 진행 중인 작품">경매중</a>
								<a href="${path}/front?key=art&methodName=searchByKeyWord&keyField=artState&keyWord=3" 
								class="genric-btn primary small" style="padding:0px 5px" title="낙찰된 작품">낙찰</a>
							</span>
							</c:if>
						</div>
								...
								<c:choose>
									<c:when test="${empty requestScope.artList}">
										<tr>
											<td colspan="12">
												<p align="center">
													<b><span style="font-size: 9pt;">등록된 작품이 없습니다.</span></b>
												</p>
											</td>
										</tr>
									</c:when>
											...
											<tr onmouseover="this.style.background='white'"
												...
												<c:choose>
													...
													<c:when test="${artDto.artState==3}">
														<td bgcolor="">
															<p>
																<span style="font-size: 9pt;">낙찰</span>
															</p>
														</td>
													</c:when>
												</c:choose>
