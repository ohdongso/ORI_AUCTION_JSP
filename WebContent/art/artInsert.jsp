...
<body>
   ...
   <!--::header part start::-->
	...
	<div class="whole-wrap" style="margin:100px">
		<div class="container box_1170">
			<div class="section-top-border">
				<div align="center">
					<div class="col-lg-8 col-md-8" style="width: 600px">
						<h2 class="mb-30" style="margin:0px; font-family: ITC Grouch">CONSIGNMENT</h2>
						<h4 class="mb-30" style="color:orange; font-family: ITC Grouch">ART STORAGE</h4>
						<form name="writeForm" method="post" action="${path}/front?key=art&methodName=insertArt" enctype="multipart/form-data">
							...
							<div class="mt-10">
								<input type="text" name="artistName" placeholder="Artist"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Artist'" required
									class="single-input">
							</div>
							<div class="mt-10">
